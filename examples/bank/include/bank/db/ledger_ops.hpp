...
[[nodiscard]] Record loadOwned(Lightweight::DataMapper& mapper, std::int64_t id, const std::string& owner,
...
[[nodiscard]] inline AccountRecord loadOwnedOpenAccount(Lightweight::DataMapper& mapper, std::int64_t accountId,
...
inline TxnRecord postEntry(Lightweight::DataMapper& mapper, const AccountRecord& account, TxnDirection direction,
                           TxnKind kind, std::int64_t amountMinor, std::int64_t counterpartyId,
...
inline TxnRecord applyCredit(Lightweight::DataMapper& mapper, AccountRecord& account, std::int64_t amountMinor,
                             TxnKind kind, std::int64_t counterpartyId, const std::string& description) {
...
inline TxnRecord applyDebit(Lightweight::DataMapper& mapper, AccountRecord& account, std::int64_t amountMinor,
                            TxnKind kind, std::int64_t counterpartyId, const std::string& description) {
