...
/// @file
/// Process-wide database lifecycle for the crm rung (rung 7), mirroring
/// `lims::db`'s exact three-function split (`examples/lims/include/lims/db/
...
///        `"DRIVER=SQLite3;Database=crm.db"`.
