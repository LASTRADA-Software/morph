...
| 9 | **Registration cost** | A map insert. | A blocking round-trip (a nested `QEventLoop`, or a condvar park). | [backend.md](backend.md), "Why registration needs a non-blocking path" |
